...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return dot; });\n/* harmony import */ var _matrix__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix */ \"./src/matrix/index.js\");\n\n\nfunction _dot2(mat1, mat2, dim) {\n  for (var _i = 0; _i < dim[0]; _i++) {\n    if (dim.length > 1) {\n      _dot2(mat1[_i], mat2[_i], dim.slice(1));\n    } else {\n      mat1[_i] = mat1[_i] * mat2[_i];\n    }\n  }\n}\n\nfunction dot() {\n  var matrices = arguments.filter(function (arg) {\n    return arg instanceof _matrix__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n  }),\n      ml = matrices.length,\n      result = matrices[0] && matrices[0].copy();\n\n  if (matrices.length && matrices.every(function (matrix) {\n    return matrix.dim() === matrices[0].dim();\n  })) {\n    for (i = 1; i < ml; i++) {\n      _dot2(result.getValues(), matrices[i].getValues(), result.size());\n    }\n  }\n\n  return result;\n}\n\n//# sourceURL=webpack://MatJS/./src/common/dot.js?");
